...
import com.nuix.evmanager.data.MimeTypeSetting;
...
public class DataProcessingSettingsControl extends JPanel {
	...
	private Map<String,MimeTypeSetting> mimeTypeSettings = new HashMap<String,MimeTypeSetting>();
	...
	public DataProcessingSettingsControl() {
		...
		btnSaveSettings.setIcon(new ImageIcon(DataProcessingSettingsControl.class.getResource("/com/nuix/evmanager/controls/page_save.png")));
		...
		btnLoadSettings.setIcon(new ImageIcon(DataProcessingSettingsControl.class.getResource("/com/nuix/evmanager/controls/folder_page.png")));
		...
		btnResetSettings.setIcon(new ImageIcon(DataProcessingSettingsControl.class.getResource("/com/nuix/evmanager/controls/cancel.png")));
...
//		}
	...
	public void setMimeTypeSettings(String mimeType, Map<String,Boolean> settings){
		mimeTypeSettings.put(mimeType, new MimeTypeSetting(mimeType,settings));
	}

	public List<MimeTypeSetting> getAllMimeTypeSettings() {
		List<MimeTypeSetting> result = new ArrayList<MimeTypeSetting>(mimeTypeSettings.values());
		return result;
	}
